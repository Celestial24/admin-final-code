...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Pie legend */
        .pie-chart-svg { gap: 18px; }
        .pie-legend { display:flex; flex-direction:column; gap:8px; font-size:0.95rem; color:#0f172a; }
        .pie-legend-item { display:flex; align-items:center; gap:10px; }
        .pie-legend .swatch { width:14px; height:14px; border-radius:3px; display:inline-block; }
        footer {
            text-align: center;
            margin-top: 40px;
            padding: 20px;
...
<body>
    ...
    <script>
        ...
        function viewTransaction(id) {
            ...
            // Create a simple alert to show transaction details
            const details = `
Transaction Details:
ID: ${record.id}
...
Venue: ${record.venue}
        ...
        function viewJournalEntry(id) {
            ...
            // Create a simple alert to show entry details
            const details = `
